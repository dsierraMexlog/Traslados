<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="abcUsuario.aspx.cs" Inherits="Traslados.WEB.abcUsuario" %>
...
<body>
    ...
    <div>
           Usuario :<asp:TextBox runat="server" ID="txtusuario"></asp:TextBox>
           Password : <asp:TextBox runat="server" ID="txtPassword"></asp:TextBox>
           Nivel : <asp:DropDownList runat="server" ID="ddlNiveles" DataTextField="nombre" DataValueField="id" ></asp:DropDownList>

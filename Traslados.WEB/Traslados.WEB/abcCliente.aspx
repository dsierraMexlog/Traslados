<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="abcCliente.aspx.cs" Inherits="Traslados.WEB.abcCliente" EnableEventValidation="false" %>
<!DOCTYPE html>
...
<body>
    ...
    <div>
        ...
        <br />
        Ciudad : <asp:DropDownList runat="server" ID="ddlCiudades" DataTextField="nombre" DataValueField="id"></asp:DropDownList>
        <br />
    ...
    <script>
        ...
        function populateCiudades() {
            ...
            $.ajax({
                ...
                url: "abcCliente.aspx/GetResultset",
